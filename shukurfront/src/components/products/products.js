...
function Products(){
    ...
    useEffect(()=>{
        serviecs.GetResource("api/products/certify")
            .then(res=>{
                product_listSet(res)

            })

        serviecs.GetResource("api/products/not_certify")
            .then(res=>{
                console.log(res)
                product_list_nSet(res)
            })

        fetch("http://127.0.0.1:8000/api/products/frequently_viewed")
            .then(data=>{
                return data.json()
            })
            .then(res=>{
